...
# PDF plots
#######################################################
pdffn = "Cirsium_areas_DEC.pdf"
pdf(pdffn, width=12, height=16)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Cirsium (areas)"
...
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), 
                                plotwhat="text", label.offset=0.05, tipcex=0.7, statecex=0.7, 
...
runslow = TRUE
resfn = "Cirsium_areas_DIVALIKE.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
pdffn = "Cirsium_areas_DIVALIKE.pdf"
pdf(pdffn, width=12, height=16)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Cirsium (areas)"
...
runslow = TRUE
resfn = "Cirsium_areas_BAYAREALIKE.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
pdffn = "Cirsium_areas_BAYAREALIKE.pdf"
pdf(pdffn, width=12, height=16)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Cirsium (areas)"
